<template>
    <v-navigation-drawer :model-value="drawer" @update:model-value="toggleSidebar" app width="260" color="black">
      <v-list>
        <v-divider></v-divider>
  
        <v-list-item to="/barber/appointments" class="sidebar-item">
          <v-icon class="mr-2" color="yellow">mdi-calendar</v-icon>
          <span class="sidebar-text">Programari</span>
        </v-list-item>
